...
matière (tenant Ressources FR) : `tenants/superprof-ressources/sources/authority-map.md`.
...
- ❌ **Homepage / page de catégorie** au lieu de la page précise portant l'information
  (cf. deep-link obligatoire, `tenants/superprof-ressources/prompts/site.md`).
