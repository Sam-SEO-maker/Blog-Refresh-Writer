...
class SheetsClient:
    ...
    def setup_sheet_formatting(self) -> bool:
        ...
        try:
            ...
            print(f"      - CHILD: light purple #DDA0DD")
            print(f"      - STANDALONE: neutral grey #C0C0C0")
            print(f"  Colonne G (action_blogpost):")
            print(f"    [OK] Data Validation (4 options)")
            print(f"    [OK] Conditional formatting (grey, blue, yellow, orange)")
            ...
            print(f"    [OK] Data Validation (3 options)")
            print(f"    [OK] Conditional formatting (yellow, green, red)")
