...
structure restent régis par `prompts/site.md` du tenant.
...
L'adresse est fixée par le **tenant** (Superprof Ressources : **tutoiement**, cf.
...
Complète l'annuaire par matière `tenants/superprof-ressources/sources/authority-map.md`
...
- Annuaire d'autorité par matière → `tenants/superprof-ressources/sources/authority-map.md`
