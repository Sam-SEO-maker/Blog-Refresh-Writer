...
description: >-
  Writes/refreshes a <your site> article in the format your WordPress expects.
...
# Article generation — <your site>

<!--
MINIMAL TECHNICAL scaffold — it fixes only what the engine requires, not how to write.
The content of this skill is YOUR site SEO/editorial expertise: it's yours to write,
there is no "correct model" to replicate.

Non-negotiable constraints (everything else is up to you):
- File: sites/<site-slug>/.claude/skills/<your-writing-skill-name>/SKILL.md
...
<!-- From here on, write your site's editorial rules freely. Structure, tone, format,
